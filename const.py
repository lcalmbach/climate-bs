...
GROUNDWATER_URL = "https://data.bs.ch/api/v2/catalog/datasets/100179/records?limit=-1&timezone=UTC&select=stationnr,geo_point_2d,stationname,year(timestamp)%20as%20year,month(timestamp)%20as%20month,avg(value)%20as%20avg_value&group_by=stationnr,geo_point_2d,stationname,year(timestamp),month(timestamp)"
...
SPIRAL = [
    {
        "rings": [11, 14, 17],
        "title": "Basel/Binningen, Temperaturdifferenz von Klimanormale ({}-{})",
        "datasource": "[Meteo Schweiz](https://www.meteoswiss.admin.ch/services-and-publications/applications/ext/climate-tables-homogenized.html)",
        "file": TEMPERATUR_LONG,
    },
    {
        "rings": [1, 2.5, 3],
        "title": "Global Temperature Change ({}-{})",
        "datasource": "[Met Office Hadley Centre](https://www.metoffice.gov.uk/hadobs/hadcrut4/data/current/download.html)",
        "file": HADCRUT_FILE_GL,
    },
    {
        "rings": [1, 2.5, 3],
        "title": "Global Temperature Change Norther hemisphere ({}-{})",
        "datasource": "[Met Office Hadley Centre](https://www.metoffice.gov.uk/hadobs/hadcrut4/data/current/download.html)",
        "file": HADCRUT_FILE_NH,
    },
]
